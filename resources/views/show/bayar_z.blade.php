								...
								<div class="x_content">
									...
									<form action="/muzaki_bayar" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input onkeyup="mult(this.value);" name="jumlah_tanggunganyangdibayar" type="number" id="jumlah_tanggunganyangdibayar" required="required" class="form-control">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input name="bayar_beras" id="bayar_beras" class="form-control" type="float">
											</div>
										</div>
										<div class="item form-group">
