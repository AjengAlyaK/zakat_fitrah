                        ...
                        <div class="col-md-12 col-sm-12 ">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form action="/muzaki_bayar" method="post" id="demo-form2" data-parsley-validate
                                        class="form-horizontal form-label-left">
                                        @csrf
                                        <div class="item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align"
                                                for="muzakki_id">Muzakki Id<span class="required"></span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <input value="{{ $zakat->id }}" name="muzakki_id" type="text"
                                                    id="muzakki_id" required="required" class="form-control">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align"
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input value="{{ $zakat->nama_muzakki }}" name="nama_KK" type="text"
                                        ...
                                        <div class="item form-group">
                                            <label for="jumlah_tanggungan"
                                                ...
                                                Tanggungan</label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <input value="{{ $zakat->jumlah_tanggungan }}" name="jumlah_tanggungan"
                                                    id="jumlah_tanggungan" class="form-control" type="number">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align"
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input onkeyup="mult(this.value);" name="jumlah_tanggunganyangdibayar"
                                                    type="number" id="jumlah_tanggunganyangdibayar"
                                                    required="required" class="form-control">
                                                {{-- value="{{$zakat->jumlah_tanggungan}}" --}}
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="bayar_beras"
                                                ...
                                                Beras</label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <input name="bayar_beras" id="bayar_beras" class="form-control"
                                                    type="float">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input name="bayar_uang" id="bayar_uang" class="form-control"
                                                    type="number">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input value="sudah mengumpulkan zakat" name="keterangan"
                                                    id="keterangan" class="form-control" type="text">
                                            </div>
                                        </div>
