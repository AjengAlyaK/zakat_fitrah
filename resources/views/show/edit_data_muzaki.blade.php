				...
				<div class="">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2><a href="/kembali_ke_tambah" class="btn btn-secondary">Kembali</a></h2>
								...
								<div class="x_content">
									...
									@endif
									<form action="/save_perubahan_muzaki/{{$muzaki->id}}" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                        @csrf
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input value="{{$muzaki->nama_muzakki}}" name="nama_muzakki" type="text" id="first-name" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input value="{{$muzaki->jumlah_tanggungan}}" name="jumlah_tanggungan" type="number" id="jumlah_tanggungan" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
