						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									...
									@endif
									<form action="/update_kategori_mustahik/{{$k_mustahik->id}}" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                        @csrf
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input value="{{$k_mustahik->nama_kategori}}" name="nama_kategori" type="text" id="first-name" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input value="{{$k_mustahik->jumlah_hak}}"" name="jumlah_hak" type="number" id="last-name" class="form-control">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input value="{{$k_mustahik->hak_uang}}"" name="hak_uang" type="number" id="hak_uang" class="form-control">
											</div>
										</div>
