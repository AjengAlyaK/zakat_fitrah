						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									...
									@endif
									<form action="/save_edit_mustahik_menerima/{{$mustahik->id}}" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                        @csrf

										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="muzakki_id">Id Mustahik<span class="required"></span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input value="{{$mustahik->id}}" autocomplete="off" name="id" type="text" id="id" required="required" class="form-control">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input value="{{$mustahik->nama}}" autocomplete="off" name="nama" type="text" id="nama" required="required" class="form-control">
											</div>
										</div>
										<div class="item form-group">
											<label for="kategori" class="col-form-label col-md-3 col-sm-3 label-align">Kategori</label>
											<div class="col-md-6 col-sm-6 ">
												<input value="{{$mustahik->kategori}}" autocomplete="off" name="kategori" id="kategori" class="form-control" type="text">
											</div>
										</div>
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="hak">Hak<span class="required"></span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input value="{{$mustahik->hak}}" autocomplete="off" name="hak" id="hak" class="form-control" type="number">
											</div>
										</div>
