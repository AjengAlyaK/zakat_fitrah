				...
				<div class="left_col scroll-view">
					...
					<div id="sidebar-menu" class="main_menu_side hidden-print main_menu ">
						...
						<ul class="nav side-menu">
							...
							<li class="active"><a href="/muzaki_sudah_bayar"><i class="fa fa-credit-card-alt"></i> Pengumpulan Zakat Fitrah <span class="fa"></span></a>
							</li>
						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form action="/edit_data_muzaki_bayar/{{$m_bayar->id}}" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                        @csrf

										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="muzakki_id">Muzzaki Id<span class="required"></span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input value="{{$m_bayar->muzakki_id}}" name="muzakki_id" type="text" id="muzakki_id" required="required" class="form-control">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input value="{{$m_bayar->nama_KK}}" name="nama_KK" type="text" id="nama_KK" required="required" class="form-control">
											</div>
										</div>
										<div class="item form-group">
											<label for="jumlah_tanggungan" class="col-form-label col-md-3 col-sm-3 label-align">Jumlah Tanggungan</label>
											<div class="col-md-6 col-sm-6 ">
												<input value="{{$m_bayar->jumlah_tanggungan}}" name="jumlah_tanggungan" id="jumlah_tanggungan" class="form-control" type="number">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<select name="jenis_bayar" id="jenis_bayar" onchange="disableJenisBayar(this)">
                                                    <option value="{{$m_bayar->jenis_bayar}}">{{$m_bayar->jenis_bayar}}</option>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input onkeyup="mult(this.value);" value="{{$m_bayar->jumlah_tanggungan}}" name="jumlah_tanggunganyangdibayar" type="number" id="jumlah_tanggunganyangdibayar" required="required" class="form-control">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input value="{{$m_bayar->bayar_beras}}" name="bayar_beras" id="bayar_beras" class="form-control" type="float">
											</div>
										</div>
										<div class="item form-group">
											<label for="bayar_uang" class="col-form-label col-md-3 col-sm-3 label-align">Bayar Uang</label>
											<div class="col-md-6 col-sm-6 ">
												<input value="{{$m_bayar->bayar_uang}}"name="bayar_uang" id="bayar_uang" class="form-control" type="number">
