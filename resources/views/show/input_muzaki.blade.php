                        ...
                        <div class="col-md-12 col-sm-12 ">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    @endif
                                    <form action="/save_muzaki" method="post" id="demo-form2" data-parsley-validate
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input autocomplete="off" name="nama_muzakki" type="text"
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input autocomplete="off" name="jumlah_tanggungan" type="number"
                                                    id="last-name" required="required" class="form-control">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <select class="form-control" name="kategori_mustahik_id" id="">
                                                    @foreach ($kategori as $k)
                                                        <option name="kategori_mustahik_id" value="{{ $k->id }}">
