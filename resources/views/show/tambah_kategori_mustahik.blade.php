                        ...
                        <div class="col-md-12 col-sm-12 ">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    @endif
                                    <br />
                                    <form action="/save_kategori_mustahik" method="post" id="demo-form2"
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input autocomplete="off" name="nama_kategori" type="text"
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input autocomplete="off" name="jumlah_hak" type="number"
                                                    id="last-name" class="form-control">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align"
                                                for="jumlah_hak">Hak Uang<span></span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <input autocomplete="off" name="hak_uang" type="number" id="last-name"
                                                    class="form-control">
                                            </div>
                                        </div>
