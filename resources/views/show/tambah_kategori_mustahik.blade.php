				...
				<div class="left_col scroll-view">
					...
					<div id="sidebar-menu" class="main_menu_side hidden-print main_menu ">
						...
						<ul class="nav side-menu">
							...
							<li class="active"><a href="/kategori_mustahik"><i class="fa fa-user"></i> Master Data Kategori Mustahik <span class="fa"></span></a>
							</li>
				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>Tambah Kategori Mustahik</h3>
						</div>
					</div>
					<div class="clearfix"></div>
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									...
									@endif
									<br />
									<form action="/save_kategori_mustahik" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                        @csrf
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input autocomplete="off" name="nama_kategori" type="text" id="first-name" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input autocomplete="off" name="jumlah_hak" type="number" id="last-name" class="form-control">
											</div>
										</div>
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="jumlah_hak">Hak Uang<span></span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input autocomplete="off" name="hak_uang" type="number" id="last-name" class="form-control">
											</div>
										</div>
